...
const jobData = [
  {
    ...
    level: "Mid",
    description: "Build and improve search systems used by billions of users worldwide.",
  ...
  },
  {
    ...
    level: "Senior",
    description: "Build high-scale retail experiences for shoppers globally.",
  ...
  },
  {
    ...
    title: "Product Designer - iOS",
    location: "Cupertino, California, USA",
    level: "Mid",
    description: "Design intuitive experiences for iOS apps across Apple devices.",
  ...
  },
  {
    ...
    location: "Seattle, Washington, USA",
    level: "Senior",
    description: "Build Azure services powering millions of applications worldwide.",
  ...
  },
  {
    ...
    level: "Mid",
    description: "Ship performant mobile messaging features at scale.",
  ...
  },
  {
    ...
    level: "Mid",
    description: "Optimize drivers and software for cutting-edge GPUs.",
  ...
  },
  {
    ...
    level: "Senior",
    description: "Scale infrastructure for AI training and inference.",
  ...
  },
  {
    ...
    level: "Mid",
    description: "Build payment solutions that power businesses globally.",
    postedDate: "2 days ago"
  },
  {
    id: 9,
    ...
    title: "Backend Engineer - Mail",
    location: "Sunnyvale, California, USA",
    level: "Mid",
    description: "Build backend services that power Yahoo Mail at scale.",
    postedDate: "1 day ago"
  }
];
